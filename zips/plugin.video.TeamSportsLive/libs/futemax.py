...
homepage = 'https://futemax.gratis'
search_page = 'https://futemax.gratis/buscar/'
    ...
    if itens_home:
        for i in itens_home:
            try:
                ...
                if not 'bbb' in name and not 'BBB' in name and not 'Fazenda' in name and not 'FAZENDA' in name:
                    try:
